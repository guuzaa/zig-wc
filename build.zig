...
pub fn build(b: *std.Build) void {
    ...
    exe.root_module.addImport("counter", counter_module);
    ...
    exe_unit_tests.root_module.addImport("counter", counter_module);
    exe_unit_tests.root_module.addImport("options", options_module);
    exe_unit_tests.root_module.addImport("formatter", formatter_module);
    exe_unit_tests.root_module.addImport("cli", cli_module);
